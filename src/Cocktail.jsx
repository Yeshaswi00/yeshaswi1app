    ...
    return(
        <div>
            <div className="mybox">
                ...
                <button style={{marginLeft:'800px',borderColor:'white',backgroundColor:'gray',color:'black',position:'relative', right:'130px'}}>Home</button>
                <button  style={{borderColor:'white',backgroundColor:'gray'}}>Aboutus</button>
                </div>
            </div>
            <div className="cocktail">
                <center><h3 style={{color:'green'}}>Search your favorite cocktail</h3>
                <input type="text" style={{width:'50%'}} id="d1" onKeyUp={()=>{search()}}/></center><br></br>
            </div>
                ...
                x.map((a)=>{
                    return a.map((b)=>{
                        return <div className="card m-2" style={{width: '12rem'}}>
                            <img className="card-img-top" src={b.strDrinkThumb} alt="card image top" style={{width:'100%'}}/>
